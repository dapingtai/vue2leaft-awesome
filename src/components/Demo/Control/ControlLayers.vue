<template>
  <div class="container">
    ...
    <div id="map">
      ...
      >
        <!--右上圖層選擇組件-->
        <GControlLayers position="topright" v-on:layerChanged="updateLayer"/>
...
import GControlLayers from "@/components/Core/control/GControlLayers";

export default {
  name: "ControlLayerDemo",
  components: {
    LMap,
    LTileLayer,
    LControlAttribution,
